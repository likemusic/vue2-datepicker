(function (global, factory) {
  ...
  var TimeRange = {
    ...
    render: function render() {
      ...
      return h("div", {
        ...
        "props": _objectSpread2({}, _objectSpread2(_objectSpread2({}, this.$props), {}, {
          value: this.startValue,
          defaultValue: defaultValues[0],
          disabledTime: this.disabledStartTime
        })),
        "on": _objectSpread2({}, _objectSpread2(_objectSpread2({}, this.$listeners), {}, {
  ...
  var DatetimePanel = {
    ...
    props: _objectSpread2(_objectSpread2(_objectSpread2({}, CalendarPanel.props), __vue_component__$b.props), {}, {
      showTimePanel: {
        type: Boolean,
        default: undefined
      }
    ...
    render: function render() {
      var h = arguments[0];
      var calendarProps = {
        props: _objectSpread2(_objectSpread2({}, pick(this.$props, Object.keys(CalendarPanel.props))), {}, {
          type: 'date',
      ...
      var timeProps = {
        props: _objectSpread2(_objectSpread2({}, pick(this.$props, Object.keys(__vue_component__$b.props))), {}, {
          showTimeHeader: true,
          value: this.currentValue
        }),
        on: {
  ...
  var DatetimeRange = {
    ...
    render: function render() {
      var h = arguments[0];
      var calendarProps = {
        props: _objectSpread2(_objectSpread2({}, pick(this.$props, Object.keys(CalendarRange.props))), {}, {
          type: 'date',
          value: this.currentValue
        }),
        on: {
      ...
      var timeProps = {
        props: _objectSpread2(_objectSpread2({}, pick(this.$props, Object.keys(TimeRange.props))), {}, {
          value: this.currentValue,
          showTimeHeader: true
        }),
        on: {
  ...
  var DatePicker = {
    ...
    methods: {
      ...
      renderContent: function renderContent() {
        ...
        var props = _objectSpread2(_objectSpread2({}, pick(this.$props, Object.keys(Component.props))), {}, {
          value: this.currentValue
        });

        var on = _objectSpread2(_objectSpread2({}, pick(this.$listeners, Component.emits || [])), {}, {
          select: this.handleSelectDate
        });
