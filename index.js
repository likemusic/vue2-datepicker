(function (global, factory) {
      ...
      [
        _vm.visible
          ? _c(
              ...
              {
                class:
                  _vm.prefixClass + '-datepicker-main ' + _vm.prefixClass + '-datepicker-popup',
                style: {
                  top: _vm.top,
                  left: _vm.left,
                  position: 'absolute',
  ...
  var DatetimePanel = {
    ...
    props: _objectSpread2(
      _objectSpread2(_objectSpread2({}, CalendarPanel.props), __vue_component__$b.props),
      {},
      {
        showTimePanel: {
          type: Boolean,
    ...
    render: function render() {
      ...
      var calendarProps = {
        props: _objectSpread2(
          _objectSpread2({}, pick(this.$props, Object.keys(CalendarPanel.props))),
          {},
          {
            type: 'date',
      ...
      var timeProps = {
        props: _objectSpread2(
          _objectSpread2({}, pick(this.$props, Object.keys(__vue_component__$b.props))),
          {},
          {
            showTimeHeader: true,
            value: this.currentValue,
  ...
  var DatetimeRange = {
    ...
    emits: ['select', 'update:show-time-panel'],
    props: _objectSpread2(
      _objectSpread2(_objectSpread2({}, CalendarRange.props), TimeRange.props),
      {},
      {
        showTimePanel: {
          type: Boolean,
    ...
    render: function render() {
      ...
      var calendarProps = {
        props: _objectSpread2(
          _objectSpread2({}, pick(this.$props, Object.keys(CalendarRange.props))),
          {},
          {
            type: 'date',
            value: this.currentValue,
      ...
      var timeProps = {
        props: _objectSpread2(
          _objectSpread2({}, pick(this.$props, Object.keys(TimeRange.props))),
          {},
          {
            value: this.currentValue,
            showTimeHeader: true,
  ...
  var DatePicker = {
    ...
    props: _objectSpread2(
      _objectSpread2({}, DatetimePanel.props),
      {},
      {
        value: {},
        valueType: {
    ...
    computed: {
      ...
      additionalInnerFormats: function additionalInnerFormats() {
        var _this2 = this;

        return this.additionalFormats.map(function (format) {
          return _this2.getInnerFormat(format);
        });
      },
      innerValue: function innerValue() {
    ...
    methods: {
      ...
      handleInputChange: function handleInputChange() {
        ...
        if (this.validMultipleType) {
          date = text.split(this.innerRangeSeparator).map(function (v) {
            return _this4.parseDate(v.trim());
          });
        } else if (this.range) {
      ...
      renderContent: function renderContent() {
        ...
        var props = _objectSpread2(
          _objectSpread2({}, pick(this.$props, Object.keys(Component.props))),
          {},
          {
            value: this.currentValue,
          }
        ...
        var on = _objectSpread2(
          _objectSpread2({}, pick(this.$listeners, Component.emits || [])),
          {},
          {
            select: this.handleSelectDate,
          }
            ...
            this.shortcuts.map(function (v, i) {
              return h(
                'button',
                {
                  ...
                  on: {
                    click: _this5.handleSelectShortcut,
                  },
                },
                [v.text]
              );
    ...
    render: function render() {
      ...
      return h(
        'div',
        {
          class:
            ((_ref = {}),
            _defineProperty(_ref, ''.concat(prefixClass, '-datepicker'), true),
            _defineProperty(_ref, ''.concat(prefixClass, '-datepicker-range'), this.range),
            _defineProperty(_ref, ''.concat(prefixClass, '-datepicker-inline'), inline),
            _defineProperty(_ref, 'disabled', disabled),
            _ref),
        },
        [
    ...
    getInnerFormat: function getInnerFormat(format) {
      var map = {
        date: 'YYYY-MM-DD',
        datetime: 'YYYY-MM-DD HH:mm:ss',
        year: 'YYYY',
