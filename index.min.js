!(function(e, t) {
  ...
  var b = {
    ...
    D = /\[([^\]]+)]|YYYY|YY?|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|m{1,2}|s{1,2}|Z{1,2}|S{1,3}|w{1,2}|x|X|a|A/g;
  function w(e) {
    for (
  ...
  var $ = /(\[[^\[]*\])|(MM?M?M?|Do|DD?|ddd?d?|w[o|w]?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|S{1,3}|x|X|ZZ?|.)/g,
    P = /\d/,
    F = /\d\d/,
    A = /\d\d?/,
    I = /[+-]?\d+/,
  ...
  H('Y', I, 'year'),
    ...
    H('MMM', E('monthsShort'), L('monthsShort', 'month')),
    H('MMMM', E('months'), L('months', 'month')),
    H('D', A, 'day'),
    H('DD', F, 'day'),
    H(['H', 'h'], A, 'hour'),
    H(['HH', 'hh'], F, 'hour'),
    ...
    H('X', /[+-]?\d+(\.\d{1,3})?/, function(e) {
      return { date: new Date(1e3 * parseFloat(e)) };
    }),
    H('d', P, 'weekday'),
    H('dd', E('weekdaysMin'), L('weekdaysMin', 'weekday')),
    H('ddd', E('weekdaysShort'), L('weekdaysShort', 'weekday')),
    H('dddd', E('weekdays'), L('weekdays', 'weekday')),
    H('w', A, 'week'),
    H('ww', F, 'week');
  var re,
    ie = (function(e, t) {
    ...
    se =
      (re = ie) && re.__esModule && Object.prototype.hasOwnProperty.call(re, 'default')
        ? re.default
        : re,
    oe = 'en',
    le = {};
  function ue(e, t, n) {
    ...
    var a = oe;
    return le[e] && (a = e), t && ((le[e] = t), (a = e)), n || (oe = a), le[e] || le[oe];
  }
  function ce(e) {
    return ue(e, null, !0);
  }
  ...
  le[oe] = { formatLocale: se, yearFormat: 'YYYY', monthFormat: 'MMM', monthBeforeYear: !0 };
  var fe,
    pe = he(
      {
        render: function() {
            ...
            return te(
              (function(e) {
                for (
                  ...
                  r.push(U(n, a, l - s));
                i.setMonth(a + 1, 0);
                for (var u = i.getDate(), c = 1; c <= u; c++) r.push(U(n, a, c));
                for (var d = 42 - (s - o + 1) - u, h = 1; h <= d; h++) r.push(U(n, a, u + h));
                return r;
      ...
      methods: {
        ...
        handleSelectYear: function(e) {
          if ('year' === this.type) {
            ...
            (this.handleCalendarChange(U(e, this.calendarMonth), 'year'),
        ...
        handleSelectMonth: function(e) {
          if ('month' === this.type) {
            ...
            (this.handleCalendarChange(U(this.calendarYear, e), 'month'),
            this.handelPanelChange('date'),
            this.partialUpdate && 1 === this.innerValue.length)
          ) {
            var n = new Date(this.innerValue[0]);
            n.setFullYear(this.calendarYear), this.emitDate(G(n, e), 'month');
          }
        },
    ...
    Se = {
      ...
      watch: {
        value: {
          ...
          handler: function() {
            var e = this;
            this.innerValue = J(this.value) ? this.value : [new Date(NaN), new Date(NaN)];
      ...
      void 0,
      {
        ...
        methods: {
          getHoursList: function() {
            var e = this;
            return xe(this.use12h ? 12 : 24, this.hourStep, this.hourOptions).map(function(t) {
          ...
          getMinutesList: function() {
            var e = this;
            return xe(60, this.minuteStep, this.minuteOptions).map(function(t) {
              return { value: new Date(e.date).setMinutes(t), text: Me(t) };
            });
          },
          getSecondsList: function() {
            var e = this;
            return xe(60, this.secondStep, this.secondOptions).map(function(t) {
              return { value: new Date(e.date).setSeconds(t), text: Me(t) };
            });
          },
  ...
  var Ye = he(
    ...
    Pe = {
      ...
      props: r({}, Ce.props, {}, _e.props, { showTimePanel: { type: Boolean, default: void 0 } }),
      data: function() {
      ...
      methods: {
        ...
        handleSelect: function(e, t) {
          ...
          ((n = ee(e, this.defaultValue)), this.disabledTime(new Date(n)))
            ? (this.currentValue = n)
            : this.emitDate(n, t);
        },
      },
      render: function() {
        var e = arguments[0],
          t = {
            props: r({}, ae(this.$props, Object.keys(Ce.props)), {
              type: 'date',
        ...
        return e('div', [
          e(Ce, f([{}, t])),
          this.timeVisible && e(_e, f([{ class: ''.concat(a, '-calendar-time') }, n])),
        ]);
      },
    },
    Fe = {
      ...
      inject: { prefixClass: { default: 'mx' } },
      emits: ['select', 'update:show-time-panel'],
      props: r({}, Se.props, {}, $e.props, { showTimePanel: { type: Boolean, default: void 0 } }),
      data: function() {
        return { defaultTimeVisible: !1, currentValue: this.value };
      },
      computed: {
      ...
      render: function() {
        var e = arguments[0],
          ...
          n = {
            props: r({}, ae(this.$props, Object.keys($e.props)), {
              value: this.currentValue,
              showTimeHeader: !0,
            }),
            on: { select: this.emitDate, clicktitle: this.closeTimePanel },
        ...
        return e('div', [
          e(Se, f([{}, t])),
          this.timeVisible && e($e, f([{ class: ''.concat(a, '-calendar-time') }, n])),
        ]);
      },
    },
    Ae = { default: Ce, time: _e, datetime: Pe },
    Ie = { default: Se, time: $e, datetime: Fe },
    je = {
      name: 'DatePicker',
      provide: function() {
        var e = this;
        ...
        shortcuts: {
          ...
          validator: function(e) {
            return (
              Array.isArray(e) &&
              e.every(function(e) {
                return ne(e) && 'string' == typeof e.text && 'function' == typeof e.onClick;
              })
            );
          },
          default: function() {
                ...
                return (
                  ne(a) &&
                    Object.keys(a).forEach(function(s) {
                      var o = a[s];
                      ne(o) && ne(n[s]) && (o = e(n[s], o)), (i = r({}, i, t({}, s, o)));
                    }),
                  i
                );
              })(ce(), this.lang)
      ...
      methods: {
        ...
        getFormatter: function(e) {
          return (ne(this.formatter) && this.formatter[e]) || (ne(this.format) && this.format[e]);
        },
        ...
        parseDate: function(e, t) {
          var n = t || this.innerFormat;
          if ('function' == typeof this.getFormatter('parse'))
            return this.getFormatter('parse')(e, n);
          var a = new Date(),
            r = [n];
          return (
            ...
            (function(e, t) {
              ...
              try {
                for (var o, l = t[Symbol.iterator](); !(r = (o = l.next()).done); r = !0) {
                  if (((a = B(e, o.value, n)), !isNaN(a.valueOf()))) return a;
                }
              } catch (e) {
                (i = !0), (s = e);
              } finally {
              ...
              return a;
            })(e, r, { locale: this.locale.formatLocale, backupDate: a })
          );
        },
        formatDate: function(e, t) {
          return (
        ...
        renderInput: function() {
          ...
          return e(
            'div',
            { class: ''.concat(t, '-input-wrapper'), on: { mousedown: this.openPopup } },
            [
              u,
              this.showClearIcon
                ? e(
                    'i',
                    { class: ''.concat(t, '-icon-clear'), on: { mousedown: this.handleClear } },
        ...
        renderContent: function() {
          var e = this.$createElement,
            ...
            a = r({}, ae(this.$props, Object.keys(n.props)), { value: this.currentValue }),
            i = r({}, ae(this.$listeners, n.emits || []), { select: this.handleSelectDate }),
  ...
  return (
    ...
    'undefined' != typeof window && window.Vue && je.install(window.Vue),
    n(je, {
      CalendarPanel: Ce,
      CalendarRange: Se,
      TimePanel: _e,
